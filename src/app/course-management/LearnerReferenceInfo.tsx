  ...
  return (
    <div className="card bg-secondary my-5 p-5 grid grid-cols-4 gap-5 content-center w-3/4 mx-auto border border-primary ">
      <div className="col-span-3 prose text-secondary-content my-auto">
        ...
        <p>
          Anyone can <Link href="/course">start learning for free, anytime</Link> in an Andamio PBL Course. A Learner Token allows you to create an on-chain record of what you know and can do, and to share it across the Andamio Network and beyond.
        </p>
