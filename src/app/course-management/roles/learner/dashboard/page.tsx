  ...
  return (
    <>
      ...
      <main className="flex flex-col w-3/4 mx-auto min-h-screen">
        <h1 className="text-3xl font-mono font-bold text-accent mt-10">{andamioConfig.title}</h1>
        <h1 className="text-6xl font-mono text-secondary-content mb-10">Learner Dashboard</h1>
